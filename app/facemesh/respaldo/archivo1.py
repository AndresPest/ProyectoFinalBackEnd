import numpy as np
from app.facemesh.emotion_processor.face_mesh.face_mesh_processor import FaceMeshProcessor
from app.facemesh.emotion_processor.data_processing.main import PointsProcessing
from app.facemesh.emotion_processor.emotions_recognition.main import EmotionRecognition
from app.facemesh.emotion_processor.emotions_visualizations.main import EmotionsVisualization
...
class EmotionRecognitionSystem:
    ...
    def frame_processing(self, face_image: np.ndarray):
        ...
        if control_process:
            ...
            raise Exception("No se detectó ninguna malla facial en la imagen.")
